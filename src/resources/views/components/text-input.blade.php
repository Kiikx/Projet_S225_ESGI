...
@php
    ...
    // Classes CSS de base
    $baseClasses = 'w-full px-4 py-3 bg-white rounded-xl text-neutral-900 placeholder-neutral-500 focus:outline-none transition-all duration-200 shadow-sm disabled:bg-neutral-100 disabled:cursor-not-allowed';
